    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cart>(entity =>
        {
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.Carts)
                ...
                .HasConstraintName("FK__Carts__CustomerI__5165187F");
        });
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Customer__1788CCAC3C1C484D");
        ...
        modelBuilder.Entity<Delivery>(entity =>
        {
            ...
            entity.HasOne(d => d.Staff).WithMany(p => p.Deliveries)
                ...
                .HasConstraintName("FK__Deliverie__Staff__5EBF139D");
        });
        ...
        modelBuilder.Entity<SupportRequest>(entity =>
        {
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.SupportRequests)
                .HasForeignKey(d => d.CustomerId)
                .HasConstraintName("FK__SupportRe__Custo__4D94879B");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC2B383699");
        ...
        modelBuilder.Entity<UserPermission>(entity =>
        {
            ...
            entity.HasOne(d => d.AssignedByNavigation).WithMany(p => p.UserPermissionAssignedByNavigations)
                ...
                .HasConstraintName("FK__UserPermi__Assig__48CFD27E");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.UserPermissionUsers)
                ...
                .HasConstraintName("FK__UserPermi__UserI__46E78A0C");
        });
