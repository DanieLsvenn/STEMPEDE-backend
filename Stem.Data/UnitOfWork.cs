...
namespace Stem.Data
{
    ...
    {
        private STEMKITshopDBContext _unitOfWorkContext;
        private ProductRepository _product;
        private UserRepository _user;
        public UnitOfWork()
        {
            _unitOfWorkContext ??= new STEMKITshopDBContext();
        }
        public UnitOfWork(STEMKITshopDBContext context)
        {
        ...
        public UserRepository UserRepository
        {
            ...
            get { return _user ??= new Repository.UserRepository(_unitOfWorkContext); }
        }
